...
echo "========================================================"
echo "   Running Ablation Study: VFPT + DCT (No Gating)       "
echo "========================================================"

# -------------------- CIFAR-100 --------------------
echo "[1/3] Running CIFAR-100 (DCT Only)..."
python tune_vtab.py \
    --train-type "fpt" \
    ...
    MODEL.PROMPT_FOURIER.USE_GATING "False" \
    \
    OUTPUT_DIR "./output_experiment/cifar100_vfpt_dct_only"

# -------------------- EuroSAT --------------------
echo "[2/3] Running EuroSAT (DCT Only)..."
python tune_vtab.py \
    --train-type "fpt" \
    ...
    MODEL.PROMPT_FOURIER.USE_GATING "False" \
    \
    OUTPUT_DIR "./output_experiment/eurosat_vfpt_dct_only"

# -------------------- CLEVR --------------------
echo "[3/3] Running CLEVR (DCT Only)..."
python tune_vtab.py \
    --train-type "fpt" \
    ...
    MODEL.PROMPT_FOURIER.USE_GATING "False" \
    \
    OUTPUT_DIR "./output_experiment/clevr_vfpt_dct_only"